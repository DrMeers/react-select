...
var compareOption = function compareOption(inputValue, option) {
  var sanitize = function sanitize(value) {
    return value === undefined || value === null ? value : value.toString().toLowerCase();
  };
  var candidate = sanitize(inputValue);
  return sanitize(option.value) === candidate || sanitize(option.label) === candidate;
};
